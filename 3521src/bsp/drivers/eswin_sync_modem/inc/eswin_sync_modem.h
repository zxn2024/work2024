...
typedef struct __sync_modem_TypeDef // modem结构体
{
    ...
    uint8_t modem_reboot_or_reset;   // 控制模块重启或复位的标志,0代表不重启或复位,1代表模块重启 2代表模块重新上电
...
extern  modem_config_buf_t   pc_config_modem_buf;
...
/***********************************************************
*函数功能: 初始化上层应用配置模块工作所需的参数，测试用
********************************************************/
void init_modem_config_buf(void);
/***********************************************************
