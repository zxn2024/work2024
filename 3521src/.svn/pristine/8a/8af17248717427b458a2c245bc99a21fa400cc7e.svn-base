...
/****************************** 设备类型 ****************************/
#define LOCAL_DEVICE_TYPE                   _WSF            /* 当前设备类型 */
...
/****************************** 版本信息 ****************************/
	...
	//<i> eg. 2404112
    #define SW_VERNUM                           "2404171"       /* 软件版本 2位年份+2位月份+3位更新序列码*/
	...
	//<i> year(2Byte) - month(2Byte) - day(2Byte) - version(1Byte)
	//<i> eg. 2404112
    #define SW_VERNUM                           "2404171"       /* 软件版本 2位年份+2位周份+3位更新序列码*/
    #define HW_VERNUM                           "V1.0"          /* 硬件版本 */
    #define MONITOR_TYPE                        _TJ             /* 监控平台 */
	...
	//<i> eg. 202404112
    #define SW_VERNUM                           "202404171"       /* 软件版本 2024：年份，03：月份，001：版本号*/
    #define HW_VERNUM                           "V1.0"          /* 硬件版本 */
    #define MONITOR_TYPE                        _TJ             /* 监控平台 */
...
//<o>BAND_NUM
//<i> 3: B3 / B8 / B41    
//<i> 5: B3 / B8 / B39 / B40 / B41
//<3=> 3 <5=> 5 
#define DEV_BAND_NUM 	( 5 )	//3: 三频设备 B3 / B8 /B41,  5: 5频设备 B3 / B8 /B39 / B40 / B41
