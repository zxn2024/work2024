...
typedef enum
{
    ...
    CAT1_SET_LINK0_IP_TPYE, // 设置link0 ip类型 
    ...
    CAT1_SET_LINK1_IP_TPYE, // 设置link1 ip类型 
...
typedef struct
{
    cat1_ec800_hw_config_t cat1_hw_config; // 硬件配置,串口,GPIO
    ...
    uint8_t ucaSimNum[30];   // SIM卡串号
    uint8_t ucaCatSwVer[30]; // 模组软件版本
    uint8_t ucaCatHwVer[30]; // 模组硬件版本
...
/*---------------------- 全局变量  ---------------------------------------*/
extern cat1_ec800_T hCat1;   // CAT1结构体
