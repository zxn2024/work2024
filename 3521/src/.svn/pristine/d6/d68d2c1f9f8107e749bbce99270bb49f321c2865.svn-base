...
#define BIT_ISO_B3_RESET_EN     (1U << 0)  //进行5G自激重新检测处理，一天最多3次
#define BIT_ISO_N41_RESET_EN     (1U << 1)  //进行5G自激重新检测处理，一天最多3次
#define BIT_ISO_B3_CLOSE_MIMO   (1U << 16)  //自激隔离度不足关断标记
#define BIT_ISO_N41_CLOSE_MIMO   (1U << 17)  //自激隔离度不足关断标记
